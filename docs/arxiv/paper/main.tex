...
Repository: \texttt{github.com/StanByriukov02/hwatom-gate-12s}, tag \texttt{t1-eval-20260522}~\cite{hardware_atom_t1}.
...
\begin{itemize}
  ...
  \item Git tag \texttt{t1-eval-20260522} on \texttt{StanByriukov02/hwatom-gate-12s} (public eval repo).
\end{itemize}
